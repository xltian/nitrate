...
HttpJSONResponseBadRequest = partial(HttpResponseBadRequest, content_type=MIMETYPE_JSON)
HttpJSONResponseServerError = partial(HttpResponseServerError, content_type=MIMETYPE_JSON)
